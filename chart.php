...
class GFPersian_Chart_Zibal {
	...
	public static function stats_page() {
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo ( ! rgget( "tab" ) || rgget( "tab" ) == "today" ) ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>"><?php _e( "امروز", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=yesterday"><?php _e( "دیروز", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last7days" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last7days"><?php _e( "هفت روز گذشته", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisweek"><?php _e( "هفته جاری", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last30days" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last30days"><?php _e( "30 روز گذشته", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thismonth"><?php _e( "ماه جاری", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=lastmonth"><?php _e( "ماه قبل", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last2month" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last2month"><?php _e( "2 ماه اخیر", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last3month" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last3month"><?php _e( "3 ماه اخیر", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last6month" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last6month"><?php _e( "6 ماه اخیر", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last9month" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last9month"><?php _e( "9 ماه اخیر", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last12month" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last12month"><?php _e( "یک سال اخیر", "gravityformszibal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "spring" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=spring"><?php _e( "بهار", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "summer" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=summer"><?php _e( "تابستان", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "fall" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=fall"><?php _e( "پاییز", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "winter" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=winter"><?php _e( "زمستان", "gravityformszibal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_zibal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisyear"><?php _e( "امسال", "gravityformszibal" ); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_zibal&view=stats&id=<?php echo rgget( "id" ) ?>&tab=selection"><?php wp_nonce_field( "search", "gf_zibal_chart" ) ?>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e( 'انتخاب', 'gravityformszibal' ) ?>"><br>
                </form>
            </ul>
            ...
            <div>
				...
				<?php } else { ?>
                    <div class="zibal_graph_container">
                        <div id="graph_placeholder" style="width:100%;height:300px;"></div>
                    </div>
					<?php
				}

				$sales_label = __( "تعداد کل پرداخت های  زیبال این فرم", "gravityformszibal" );

				$transaction_totals = GFPersian_DB_zibal::get_transaction_totals( $form_id );
                ...
                <div class="zibal_summary_container">
                    <div class="zibal_summary_item">
                        <div
                                class="zibal_summary_title"><?php _e( 'جمع پرداخت های  زیبال این فرم', 'gravityformszibal' ) ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
            ...
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های  همه روشهای این فرم", "gravityformszibal" );

				$transaction_totals = GFPersian_DB_zibal::get_transaction_totals_gateways( $form_id );
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                ...
                <div class="zibal_summary_container">
                    ...
                    <div class="zibal_summary_item">
                        <div
                                class="zibal_summary_title"><?php _e( "جمع پرداخت های  همه روشهای این فرم", "gravityformszibal" ) ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zibal_summary_item">
                        ...
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="zibal_summary_item">
                        <div class="zibal_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zibal_summary_item">
                        ...
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zibal_summary_item">
                        <div class="zibal_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["midt"], 'fa' ) ?></div>
                    </div>
            ...
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های درگاه زیبال", "gravityformszibal" );

				$transaction_totals = GFPersian_DB_zibal::get_transaction_totals_this_gateway();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zibal_summary_container">
                    <div class="zibal_summary_item">
                        <div
                                class="zibal_summary_title"><?php _e( "جمع پرداخت های  همه فرمهای زیبال", "gravityformszibal" ) ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " کل درآمد های سایت ( همه روشها برای همه فرم ها)", "gravityformszibal" ) ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های همه فرمهای سایت", "gravityformszibal" );

				$transaction_totals = GFPersian_DB_zibal::get_transaction_totals_site();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zibal_summary_container">
                    <div class="zibal_summary_item">
                        <div
                                class="zibal_summary_title"><?php _e( "جمع کل پرداخت های همه فرمهای سایت", "gravityformszibal" ) ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zibal_summary_item">
                        ...
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_site["revenue"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zibal_summary_item">
                        ...
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_site["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zibal_summary_item">
                        <div class="zibal_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div
                                class="zibal_summary_value"><?php echo GF_tr_num( $chart_info_site["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function startShowTooltip(item, graph) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        jQuery("#zibal_graph_tooltip").remove();
			...
			<?php if (! empty( $chart_info["series"] )) :?>
            var zibal_graph_tooltips = <?php echo GF_tr_num( $chart_info["tooltips"], 'fa' ) ?>;
            ...
            jQuery("#graph_placeholder").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zibal_graph_tooltips);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder1").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zibal_graph_tooltip1s1);
            });
			<?php endif;?>


			<?php if (! empty( $chart_info_gateways["series"] )) :?>
            var zibal_graph_tooltip2s2 = <?php echo GF_tr_num( $chart_info_gateways["tooltips"], 'fa' ) ?>;
            ...
            jQuery("#graph_placeholder2").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zibal_graph_tooltip2s2);
            });
			<?php endif;?>


			<?php if (! empty( $chart_info_site["series"] )) :?>
            var zibal_graph_tooltip3s3 = <?php echo GF_tr_num( $chart_info_site["tooltips"], 'fa' ) ?>;
            ...
            jQuery("#graph_placeholder3").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zibal_graph_tooltip3s3);
            });
			<?php endif;?>

            function showTooltip(x, y, contents) {
                jQuery('<div id="zibal_graph_tooltip">' + contents + '<div class="tooltip_tip1"></div></div>').css({
                    position: 'absolute',
                    display: 'none',
                    opacity: 1,
                    width: '150px',
	...
	public static function lastxdays_chart_info( $form_id, $chart, $x ) {
		...
		if ( $chart == 1 ) {
			...
			$t       = __( 'زیبال این فرم', 'gravityformszibal' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_zibal::get_entry_table_name() . " l
                                        WHERE form_id={$form_id} AND l.status='active' AND l.is_fulfilled=1 AND l.payment_method='zibal'
                                        GROUP BY date(date)
		...
		if ( $chart == 2 ) {
			...
			$t       = __( 'همه روشهای این فرم', 'gravityformszibal' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_zibal::get_entry_table_name() . " l
		...
		if ( $chart == 3 ) {
			$c       = 'orang';
			$dt      = "}";
			$t       = __( "همه فرمهای زیبال", 'gravityformszibal' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_zibal::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1 AND l.payment_method='zibal'
                                        GROUP BY date(date)
                                        ORDER BY payment_date desc" );
		}
		...
		if ( $chart == 4 ) {
			...
			$t       = __( "همه فرمهای سایت", 'gravityformszibal' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_zibal::get_entry_table_name() . " l
		...
		if ( $x == 7 ) {
			$n   = __( '7 روز', 'gravityformszibal' );
			$mid = 7;
		}
		if ( $x == 30 ) {
			$n   = __( '30 روز', 'gravityformszibal' );
			$mid = 30;
		}

		$sales_label = sprintf( __( "تعداد پرداخت های %s گذشته %s", 'gravityformszibal' ), $n, $t );

		$midt          = $mid ? $sales_week / $mid : 0;
		$mid           = ( $mid ? GFCommon::to_money( $revenue_week / $mid ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$midt          = number_format( $midt, 3, '.', '' ) . __( " در روز", 'gravityformszibal' );
		$midt_label    = sprintf( __( "میانگین تعداد پرداخت های %s گذشته %s", 'gravityformszibal' ), $n, $t );
		$mid_label     = sprintf( __( "میانگین پرداخت های %s گذشته %s", 'gravityformszibal' ), $n, $t );
		$revenue_week  = GFCommon::to_money( $revenue_week );
		$revenue_label = sprintf( __( "جمع پرداخت های %s گذشته %s", 'gravityformszibal' ), $n, $t );
	...
	public static function thisweek_chart_info( $form_id, $chart ) {
		...
		if ( $chart == 4 ) {
			$c       = 'red';
			$dt      = "points: { symbol: 'triangle', fillColor: '#AA4643' }, color: '#AA4643'}";
			$t       = __( "همه فرم های سایت", 'gravityformszibal' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_zibal::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1
                                        GROUP BY date(date)
		...
		$sales_label = __( "تعداد پرداخت های  این هفته ", 'gravityformszibal' ) . $t;

		$midt          = $sales_week / 7;
		$midt          = ( $midt ? number_format( $midt, 3, '.', '' ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$midt_label    = __( "میانگین تعداد پرداخت های  این هفته ", 'gravityformszibal' ) . $t;
		$mid           = GFCommon::to_money( $revenue_week / 7 ) . __( " در روز", 'gravityformszibal' );
		$mid_label     = __( "میانگین پرداخت های این هفته ", 'gravityformszibal' ) . $t;
		$revenue_week  = GFCommon::to_money( $revenue_week );
		$revenue_label = __( "جمع پرداخت های  این هفته ", 'gravityformszibal' ) . $t;
	...
	public static function targetmdays_chart_info( $form_id, $chart, $xmonth ) {
		...
		if ( ! empty( $results ) ) {
			...
			if ( $xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12 ) {
				...
				$n = $n . __( " ماه اخیر", "gravityformszibal" );

				if ( $xmonth == 12 ) {
					$n = __( " یکسال اخیر", "gravityformszibal" );
				}
			}
		...
		if ( $xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12 ) {
			...
			if ( $xmonth == 12 ) {
				$n = __( 'یک سال اخیر', 'gravityformszibal' );
			}
		}

		$sales_label = __( 'تعداد پرداخت های  ', 'gravityformszibal' ) . $n . ' ' . $t;
		...
		$midt             = number_format( $midt, 3, '.', '' ) . __( " در روز", 'gravityformszibal' );
		$midt_label       = __( 'میانگین تعداد پرداخت های ', 'gravityformszibal' ) . $n . ' ' . $t;
		$mid              = ( $midd ? GFCommon::to_money( $revenue_thistday / $midd ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$mid_label        = __( 'میانگین پرداخت های ', 'gravityformszibal' ) . $n . ' ' . $t;
		$revenue_label    = __( 'جمع پرداخت های  ', 'gravityformszibal' ) . $n . ' ' . $t;
	...
	public static function tyday_chart_info( $form_id, $chart, $day ) {
		...
		$date          = new DateTime( $today );
		if ( $day == 1 ) {
			$n    = __( "امروز", 'gravityformszibal' );
			$baze = date( 'm d , Y', $tday );
			$ty   = date( 'Ymd', $tday );
		} else if ( $day == 2 ) {
			$n = __( "دیروز", 'gravityformszibal' );
			$date->sub( new DateInterval( 'P1DT0H0M' ) );
		...
		$midt          = $sales_today / 24;
		$midt          = number_format( $midt, 3, '.', '' ) . __( " در ساعت", "gravityformszibal" );
		$midt_label    = __( "میانگین تعداد پرداخت های ", "gravityformszibal" ) . $n . " " . $t;
		$mid           = GFCommon::to_money( $revenue_today / 24 ) . __( " در ساعت", "gravityformszibal" );
		$mid_label     = __( "میانگین پرداخت های ", "gravityformszibal" ) . $n . " " . $t;
	...
	public static function yearly_chart_info( $form_id, $chart ) {
		...
		$sales_label = __( "تعداد پرداخت های امسال ", "gravityformszibal" ) . $t;
		...
		$midt           = number_format( $midt, 3, '.', '' ) . __( " در روز", "gravityformszibal" );
		$midt_label     = __( "میانگین تعداد پرداخت های امسال ", "gravityformszibal" ) . $t;
		$mid            = ( $midd ? GFCommon::to_money( $revenue_yearly / $midd ) : 0 ) . __( " در روز", "gravityformszibal" );
		$mid_label      = __( "میانگین پرداخت های امسال ", "gravityformszibal" ) . $t;
		$revenue_yearly = GFCommon::to_money( $revenue_yearly );
		$revenue_label  = __( "جمع پرداخت های امسال ", "gravityformszibal" ) . $t;
	...
	public static function season_chart_info( $form_id, $chart, $season ) {
		...
		if ( $season == 2 ) {
			$n      = __( 'تابستان', 'gravityformszibal' );
			$ebtda  = $avalesal_t;
		...
		$midt           = ( $midt ? number_format( $midt, 3, '.', '' ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$midt_label     = __( "میانگین تعداد پرداخت های  ", 'gravityformszibal' ) . $n . " " . $t;
		$mid            = ( $midd ? GFCommon::to_money( $revenue_season / $midd ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$mid_label      = __( "میانگین پرداخت های  ", 'gravityformszibal' ) . $n . " " . $t;
		$revenue_label  = __( "جمع پرداخت های  ", 'gravityformszibal' ) . $n . " " . $t;
	...
	public static function selection_chart_info( $form_id, $chart, $min, $max ) {
		...
		$sales_label = __( "تعداد پرداخت های بازه انتخابی ", 'gravityformszibal' ) . $t;

		$midt          = $midd ? $sales_today / $midd : 0;
		$midt          = number_format( $midt, 3, '.', '' ) . __( " در روز", 'gravityformszibal' );
		$midt_label    = __( "میانگین تعداد پرداخت های  ", 'gravityformszibal' ) . $t . "";
		$mid           = ( $midd ? GFCommon::to_money( $revenue_today / $midd ) : 0 ) . __( " در روز", 'gravityformszibal' );
		$mid_label     = __( "میانگین پرداخت های  ", 'gravityformszibal' ) . $t . "";
		$revenue_today = GFCommon::to_money( $revenue_today );
		$revenue_label = __( "جمع پرداخت های بازه انتخابی ", 'gravityformszibal' ) . $t;
