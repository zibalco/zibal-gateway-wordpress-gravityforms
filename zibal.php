...
class GFPersian_Gateway_Zibal {
        ...
        <h3>
			<span><i class="fa fa-credit-card"></i> <?php esc_html_e( 'زیبال', 'gravityformszibal' ) ?>
                <a id="add-new-confirmation" class="add-new-h2"
                   href="<?php echo esc_url( admin_url( 'admin.php?page=gf_zibal&view=edit&fid=' . absint( rgget( "id" ) ) ) ) ?>"><?php esc_html_e( 'افزودن فید جدید', 'gravityformszibal' ) ?></a></span>
            <a class="add-new-h2"
               href="admin.php?page=gf_zibal&view=stats&id=<?php echo absint( rgget( "id" ) ) ?>"><?php _e( "نمودار ها", "gravityformszibal" ) ?></a>
        </h3>
        ...
        <div class="wrap">
			...
			<?php if ( $arg != 'per-form' ) { ?>
                ...
                <h2>
					...
					if ( get_option( "gf_zibal_configured" ) ) { ?>
                        <a class="add-new-h2"
                           href="admin.php?page=gf_zibal&view=edit"><?php _e( "افزودن جدید", "gravityformszibal" ) ?></a>
						<?php
					} ?>
                </h2>
            ...
            <form id="confirmation_list_form" method="post">
                ...
                <div class="tablenav">
                    <div class="alignleft actions" style="padding:8px 0 7px 0;">
                        <label class="hidden"
                               for="bulk_action"><?php _e( "اقدام دسته جمعی", "gravityformszibal" ) ?></label>
                        ...
                        <a class="button button-primary"
                           href="admin.php?page=gf_settings&subview=gf_zibal"><?php _e( 'تنظیمات حساب زیبال', 'gravityformszibal' ) ?></a>
                    </div>
                </div>
                <table class="wp-list-table widefat fixed striped toplevel_page_gf_edit_forms" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th scope="col" id="active" class="manage-column"
                            style="width:<?php echo $arg != 'per-form' ? '50px' : '20px' ?>"><?php echo $arg != 'per-form' ? __( 'وضعیت', 'gravityformszibal' ) : '' ?></th>
                        <th scope="col" class="manage-column"
                            style="width:<?php echo $arg != 'per-form' ? '65px' : '30%' ?>"><?php _e( " آیدی فید", "gravityformszibal" ) ?></th>
						<?php if ( $arg != 'per-form' ) { ?>
                            <th scope="col"
                                class="manage-column"><?php _e( "فرم متصل به درگاه", "gravityformszibal" ) ?></th>
						<?php } ?>
                    ...
                    <tr>
                        ...
                        <th scope="col" id="active"
                            class="manage-column"><?php echo $arg != 'per-form' ? __( 'وضعیت', 'gravityformszibal' ) : '' ?></th>
						...
						foreach ( $settings as $setting ) {
                            ...
                            <tr class='author-self status-inherit' valign="top">
                                ...
                                <td><img style="cursor:pointer;width:25px"
                                         ...
                                         alt="<?php echo $setting["is_active"] ? __( "درگاه فعال است", "gravityformszibal" ) : __( "درگاه غیر فعال است", "gravityformszibal" ); ?>"
                                         title="<?php echo $setting["is_active"] ? __( "درگاه فعال است", "gravityformszibal" ) : __( "درگاه غیر فعال است", "gravityformszibal" ); ?>"
                                ...
                                <td><?php echo $setting["id"] ?>
									<?php if ( $arg == 'per-form' ) { ?>
                                        <div class="row-actions">
                                                <span class="edit">
                                                    <a title="<?php _e( "ویرایش فید", "gravityformszibal" ) ?>"
                                                       href="admin.php?page=gf_zibal&view=edit&id=<?php echo $setting["id"] ?>"><?php _e( "ویرایش فید", "gravityformszibal" ) ?></a>
                                                    |
                                                </span>
                                            <span class="trash">
                                                    <a title="<?php _e( "حذف", "gravityformszibal" ) ?>"
                                                       href="javascript: if(confirm('<?php _e( "فید حذف شود؟ ", "gravityformszibal" ) ?> <?php _e( "\'Cancel\' برای انصراف, \'OK\' برای حذف کردن.", "gravityformszibal" ) ?>')){ DeleteSetting(<?php echo $setting["id"] ?>);}"><?php _e( "حذف", "gravityformszibal" ) ?></a>
                                                </span>
                                        </div>
									<?php } ?>
                                </td>
								...
								<?php if ( $arg != 'per-form' ) { ?>
                                    <td class="column-title">
                                        <strong><a class="row-title"
                                                   href="admin.php?page=gf_zibal&view=edit&id=<?php echo $setting["id"] ?>"
                                                   title="<?php _e( "تنظیم مجدد درگاه", "gravityformszibal" ) ?>"><?php echo $setting["form_title"] ?></a></strong>
                                        ...
                                        <div class="row-actions">
                                            ...
                                            <span class="trash">
                                                <a title="<?php _e( "حذف فید", "gravityformszibal" ) ?>"
                                                   href="javascript: if(confirm('<?php _e( "فید حذف شود؟ ", "gravityformszibal" ) ?> <?php _e( "\'Cancel\' برای انصراف, \'OK\' برای حذف کردن.", "gravityformszibal" ) ?>')){ DeleteSetting(<?php echo $setting["id"] ?>);}"><?php _e( "حذف", "gravityformszibal" ) ?></a>
                                                |
                                            </span>
                                            <span class="view">
                                                <a title="<?php _e( "ویرایش فرم", "gravityformszibal" ) ?>"
                                                   href="admin.php?page=gf_edit_forms&id=<?php echo $setting["form_id"] ?>"><?php _e( "ویرایش فرم", "gravityformszibal" ) ?></a>
                                                |
                                            </span>
                                            <span class="view">
                                                <a title="<?php _e( "مشاهده صندوق ورودی", "gravityformszibal" ) ?>"
                                                   href="admin.php?page=gf_entries&view=entries&id=<?php echo $setting["form_id"] ?>"><?php _e( "صندوق ورودی", "gravityformszibal" ) ?></a>
                                                |
                                            </span>
                                            <span class="view">
                                                <a title="<?php _e( "نمودارهای فرم", "gravityformszibal" ) ?>"
                                                   href="admin.php?page=gf_zibal&view=stats&id=<?php echo $setting["form_id"] ?>"><?php _e( "نمودارهای فرم", "gravityformszibal" ) ?></a>
                                            </span>
                                        </div>
                                    </td>
								<?php } ?>
                ...
                <div id="edit_payment_status_details" style="display:block">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="zibal_transaction_id" name="zibal_transaction_id"
	...
	public static function settings_page() {
        ...
        <form action="" method="post">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label
                                for="gf_zibal_configured"><?php _e( "فعالسازی", "gravityformszibal" ); ?></label>
                    </th>
                    <td>
                        <input type="checkbox" name="gf_zibal_configured"
                               id="gf_zibal_configured" <?php echo get_option( "gf_zibal_configured" ) ? "checked='checked'" : "" ?>/>
                        <label class="inline"
                               for="gf_zibal_configured"><?php _e( "بله", "gravityformszibal" ); ?></label>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row"><label
                                for="gf_zibal_direct"><?php _e( "زیبال دایرکت (درگاه مستقیم)؟", "gravityformszibal" ); ?></label>
                    </th>
                    <td>

                        <input type="radio" name="gf_zibal_direct"
                               value="1" <?php echo rgar( $settings, 'direct' ) == "1" ? "checked='checked'" : "" ?>/>
						<?php _e( "فعال", "gravityformszibal" ); ?>

                        <input type="radio" name="gf_zibal_direct"
                               value="0" <?php echo rgar( $settings, 'direct' ) != "0" ? "checked='checked'" : "" ?>/>
						<?php _e( "غیرفعال", "gravityformszibal" ); ?>
                ...
                <tr>
                    <th scope="row"><label
                                for="gf_zibal_merchent"><?php _e( "کد مرچنت", "gravityformszibal" ); ?></label></th>
                    <td>
                        <input style="width:350px;text-align:left;direction:ltr !important" type="text"
                               id="gf_zibal_merchent" name="gf_zibal_merchent"
                ...
                <tr>
                    ...
                    <td>
                        <input style="width:350px;" type="text" id="gf_zibal_gname" name="gf_zibal_gname"
                ...
                <tr>
                    <td colspan="2"><input style="font-family:tahoma !important;" type="submit"
                                           name="gf_zibal_submit" class="button-primary"
                                           value="<?php _e( "ذخیره تنظیمات", "gravityformszibal" ) ?>"/></td>
                </tr>
        ...
        <form action="" method="post">
			...
			if ( self::has_access( "gravityforms_zibal_uninstall" ) ) {
                ...
                <div class="delete-alert alert_red">
                    ...
                    <div
                            class="gf_delete_notice"><?php _e( "تذکر : بعد از غیرفعالسازی تمامی اطلاعات مربوط به زیبال حذف خواهد شد", "gravityformszibal" ) ?></div>
	...
	private static function config_page() {
        ...
        <div class="wrap gforms_edit_form gf_browser_gecko">
            ...
            <h2 class="gf_admin_page_title"><?php _e( "پیکربندی درگاه زیبال", "gravityformszibal" ) ?>
				...
				<?php if ( ! empty( $_get_form_id ) ) { ?>
					...
					<span
                            class="gf_admin_page_formid"><?php echo sprintf( __( "فید: %s", "gravityformszibal" ), $id ) ?></span>
					<span
                            class="gf_admin_page_formname"><?php echo sprintf( __( "فرم: %s", "gravityformszibal" ), $form_name ) ?></span>
				</span>
				<?php } ?>

            </h2>
            <a class="button add-new-h2" href="admin.php?page=gf_settings&subview=gf_zibal"
               style="margin:8px 9px;"><?php _e( "تنظیمات حساب زیبال", "gravityformszibal" ) ?></a>
			...
			if ( ! rgempty( "gf_zibal_submit" ) ) {
                ...
                <div class="updated fade"
                     style="padding:6px"><?php echo sprintf( __( "فید به روز شد . %sبازگشت به لیست%s.", "gravityformszibal" ), "<a href='?page=gf_zibal'>", "</a>" ) ?></div>
				<?php
			}
							...
							if ( RG_CURRENT_VIEW != 'entry' ) { ?>
                                <select name="form_switcher" id="form_switcher"
									...
									<?php foreach ( $feeds as $feed ) {
                                        ...
                                        <option
                                                value="<?php echo $feed["id"] ?>" <?php echo $selected ?> ><?php echo sprintf( __( 'فرم: %s (فید: %s)', 'gravityformszibal' ), $feed["form_title"], $feed["id"] ) ?></option>
									<?php } ?>
                                </select>
								<?php
							}
                            ...
                            <form method="post" action="" id="gform_form_settings">
                                ...
                                <table class="form-table gforms_form_settings" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr style="<?php echo rgget( 'id' ) || rgget( 'fid' ) ? 'display:none !important' : ''; ?>">
                                        ...
                                        <td>
                                            <select id="gf_zibal_form" name="gf_zibal_form"
                                                    onchange="GF_SwitchFid(jQuery(this).val());">
                                                <option
                                                        value=""><?php _e( "یک فرم انتخاب نمایید", "gravityformszibal" ); ?> </option>
												<?php
                                            ...
                                            <img
                                                    ...
                                                    id="zibal_wait" style="display: none;"/>
                                        </td>
                                    </tr>
								...
								<?php if ( empty( $has_product ) || ! $has_product ) { ?>
                                    <div id="gf_zibal_invalid_product_form" class="gf_zibal_invalid_form"
								...
								<?php } else { ?>
                                    <table class="form-table gforms_form_settings"
                                           id="zibal_field_group" <?php echo empty( $_get_form_id ) ? "style='display:none;'" : "" ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="gf_zibal_type"
                                                       id="gf_zibal_type_subscription"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="gf_zibal_desc_pm" id="gf_zibal_desc_pm"
                                                       class="fieldwidth-1"
                                                       value="<?php echo rgar( $config["meta"], "desc_pm" ) ?>"/>
                                                <span
                                                        class="description"><?php _e( "شورت کد ها : {form_id} , {form_title} , {entry_id}", "gravityformszibal" ); ?></span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>
												<?php _e( "ایمیل پرداخت کننده", "gravityformszibal" ); ?>
                                            </th>
                                            <td class="zibal_customer_fields_email">
												<?php
												if ( ! empty( $form ) ) {
                                        ...
                                        <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                            ...
                                            <td>
                                                <select id="gf_zibal_update_action1"
                                                        name="gf_zibal_update_action1">
                                                    <option
                                                            value="default" <?php echo rgar( $config["meta"], "update_post_action1" ) == "default" ? "selected='selected'" : "" ?>><?php _e( "وضعیت پیشفرض فرم", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="publish" <?php echo rgar( $config["meta"], "update_post_action1" ) == "publish" ? "selected='selected'" : "" ?>><?php _e( "منتشر شده", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="draft" <?php echo rgar( $config["meta"], "update_post_action1" ) == "draft" ? "selected='selected'" : "" ?>><?php _e( "پیشنویس", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="pending" <?php echo rgar( $config["meta"], "update_post_action1" ) == "pending" ? "selected='selected'" : "" ?>><?php _e( "در انتظار بررسی", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="private" <?php echo rgar( $config["meta"], "update_post_action1" ) == "private" ? "selected='selected'" : "" ?>><?php _e( "خصوصی", "gravityformszibal" ) ?></option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                            ...
                                            <td>
                                                <select id="gf_zibal_update_action2"
                                                        name="gf_zibal_update_action2">
                                                    <option
                                                            value="dont" <?php echo rgar( $config["meta"], "update_post_action2" ) == "dont" ? "selected='selected'" : "" ?>><?php _e( "عدم ایجاد پست", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="default" <?php echo rgar( $config["meta"], "update_post_action2" ) == "default" ? "selected='selected'" : "" ?>><?php _e( "وضعیت پیشفرض فرم", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="publish" <?php echo rgar( $config["meta"], "update_post_action2" ) == "publish" ? "selected='selected'" : "" ?>><?php _e( "منتشر شده", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="draft" <?php echo rgar( $config["meta"], "update_post_action2" ) == "draft" ? "selected='selected'" : "" ?>><?php _e( "پیشنویس", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="pending" <?php echo rgar( $config["meta"], "update_post_action2" ) == "pending" ? "selected='selected'" : "" ?>><?php _e( "در انتظار بررسی", "gravityformszibal" ) ?></option>
                                                    <option
                                                            value="private" <?php echo rgar( $config["meta"], "update_post_action2" ) == "private" ? "selected='selected'" : "" ?>><?php _e( "خصوصی", "gravityformszibal" ) ?></option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="gf_zibal_addon"
                                                       id="gf_zibal_addon_true"
                                                       value="true" <?php echo rgar( $config['meta'], 'addon' ) == "true" ? "checked='checked'" : "" ?>/>
                                                <label for="gf_zibal_addon"></label>
                                                <span
                                                        class="description"><?php _e( 'برخی افزودنی های گرویتی فرم دارای متد add_delayed_payment_support هستند. در صورتی که میخواهید این افزودنی ها تنها در صورت تراکنش موفق عمل کنند این گزینه را تیک بزنید.', 'gravityformszibal' ); ?></span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="gf_zibal_conditional_option">
                                            ...
                                            <td>
                                                <input type="checkbox" id="gf_zibal_conditional_enabled"
                                                       name="gf_zibal_conditional_enabled" value="1"
                                                       onclick="if(this.checked){jQuery('#gf_zibal_conditional_container').fadeIn('fast');} else{ jQuery('#gf_zibal_conditional_container').fadeOut('fast'); }" <?php echo rgar( $config['meta'], 'zibal_conditional_enabled' ) ? "checked='checked'" : "" ?>/>
                                                        ...
                                                        <td>
                                                            <div id="gf_zibal_conditional_container" <?php echo ! rgar( $config['meta'], 'zibal_conditional_enabled' ) ? "style='display:none'" : "" ?>>
																...
																foreach ( $condition_field_ids as $i => $value ):?>
                                                                    ...
                                                                    <div class="gf_zibal_conditional_div"
                                                                         id="gf_zibal_<?php echo $i; ?>__conditional_div">

                                                                        <select class="gf_zibal_conditional_field_id"
                                                                                id="gf_zibal_<?php echo $i; ?>__conditional_field_id"
                                                                                name="gf_zibal_conditional_field_id[<?php echo $i; ?>]"
                                                                                title="">
                                                                        </select>

                                                                        <select class="gf_zibal_conditional_operator"
                                                                                id="gf_zibal_<?php echo $i; ?>__conditional_operator"
                                                                                name="gf_zibal_conditional_operator[<?php echo $i; ?>]"
                                                                        ...
                                                                        <div id="gf_zibal_<?php echo $i; ?>__conditional_value_container"
                                                                ...
                                                                <input type="hidden"
                                                                       ...
                                                                       id="gf_zibal_conditional_counter">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="submit" class="button-primary gfbutton"
                                                       name="gf_zibal_submit"
                                                       value="<?php _e( "ذخیره", "gravityformszibal" ); ?>"/>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
        ...
        <style type="text/css">
            ...
            #gf_zibal_conditional_container *, .delete_this_condition *, .add_new_condition * {
                outline: none !important;
            }
	...
	public static function Request( $confirmation, $form, $entry, $ajax ) {
		...
		if ( ! $custom ) {
			...
			$Result = self::postToZibal('request',
				array(
					'merchant'  => $merchantId,
					'amount'      => $Amount,
			...
			if ( empty( $_GET['no'] ) || $_GET['no'] != 'true' ) {
				...
				if ( isset( $_GET['success'] ) &&  $_GET['success']  == '1' ) {
					...
					$merchantId = self::get_merchent();
						...
						$Result = self::postToZibal('verify',
							array(
								'merchant' => $merchantId,
								'trackId'  => $trackId
							)
